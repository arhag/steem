...
#define STEEMIT_BLOCKCHAIN_VERSION              ( version(0, 12, 3) )
...
#define STEEMIT_WILL_CHANGE_PERIOD                          fc::seconds(60)
#define STEEMIT_INHERITANCE_CHANGE_PERIOD                   fc::seconds(60)
#define STEEMIT_MIN_ACTIVITY_PROOF_DURATION                 fc::seconds(12)
#define STEEMIT_MIN_BENEFICIARY_WAITING_PERIOD              fc::seconds(60)
#define STEEMIT_INHERITANCE_MATURITY_DURATION_TO_MERGE      (STEEMIT_MAX_CASHOUT_WINDOW_SECONDS + STEEMIT_SECOND_CASHOUT_WINDOW) // 4 days 
...
#define STEEMIT_WILL_CHANGE_PERIOD                          fc::days(30)
#define STEEMIT_INHERITANCE_CHANGE_PERIOD                   fc::days(30)
#define STEEMIT_MIN_ACTIVITY_PROOF_DURATION                 fc::days(1)
#define STEEMIT_MIN_BENEFICIARY_WAITING_PERIOD              fc::days(30)
#define STEEMIT_INHERITANCE_MATURITY_DURATION_TO_MERGE      (STEEMIT_MAX_CASHOUT_WINDOW_SECONDS + STEEMIT_SECOND_CASHOUT_WINDOW) // 44 days 
...
#define STEEMIT_MAX_WILL_ITEMS                  50
